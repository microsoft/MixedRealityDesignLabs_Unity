...
namespace HUX.Spatial
{
    ...
    public abstract class Solver : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            // This may be serialized as zero for old instances
        ...
        {
            throw new System.Exception("Must implement SolverUpdate from SolverBase");
            /*if (solverLink != null)
			{
				GoalPosition = solverLink.GoalPosition;
				GoalRotation = solverLink.GoalRotation;
				GoalScale = solverLink.GoalScale;
			}
