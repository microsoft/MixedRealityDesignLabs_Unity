...
# Unity Compatibility
The current supported version of Unity is **Unity 2017**.  If you are looking to have support for previous versions of Unity you can sync to previous commits.
